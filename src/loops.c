...
void print_odd_backward(int start_num,int end_num){
  int last_odd = end_num - !(end_num % 2);
  for(int odd = last_odd; odd >=start_num; odd-=2 ){
    printf("%d\n",odd);
  }
}
